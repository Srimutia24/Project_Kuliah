...
$alamat = $_GET['alamat'];
$waktu_acara = $_GET['alamat'];

while ($record = mysqli_fetch_array($query)) {
    $result[] = $record;
}
$select_menu = mysqli_query($conn, "SELECT id,nama_mc FROM tb_daftarmc");
?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-floating mb-3">
                        <input disabled type="text" class="form-control " id="waktu_acara" value="<?php echo $waktu_acara; ?>">
            ...
            <?php
            if (empty($result)) {
                echo "Data MC yang Dibooking tidak ada";
            } else {
