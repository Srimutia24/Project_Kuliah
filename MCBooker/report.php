...
<div class="col-lg-9 mt-2">
    <div class="card">
        ...
        <div class="card-body">
            <?php
            if (empty($result)) {
                echo "Data Daftar MC yang disewa tidak ada tidak ada";
            } else {
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a class="btn btn-info btn-sm me-1" href="./?x=viewitem&order=  <?php echo $row['id_order'] . "&pelanggan=" . $row['pelanggan'] . "&alamat=" . $row['alamat']. "&waktu_acara=" . $row['waktu_acara']  ?>"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </td>
                                </tr>
